...
} from "../../../redux_store/actions/users/crud-user-type.actions";
/**
 * Validation schema
  ...
  return (
    <Container style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Formik
          initialValues={{
            user_type: props.selectedUserType
              ? props.selectedUserType.user_type
              : "",
            description: props.selectedUserType
              ? props.selectedUserType.description
              : ""
          }}
